...
### 9. 整体白话解读（普通话总结，置于分析最末尾）

> 这是专业分析的"翻译层"，不是替代层。把前面已论证的命理判断翻译成普通话，让非命理背景的读者也能理解。

#### 触发条件

- **完整分析追加**：用户要求"详细综合分析/看一下这个八字/全面分析"时，在专业分析最末尾追加本模块
- **简短问答不追加**：用户只问一个具体问题（如"我哪年结婚""适不适合创业"），只答具体问题，不追加白话解读
- **夫妻合参不追加**：合参有自己的总评和共同建议，不追加个人白话解读（避免冗余）

#### 五个模块（按顺序，不可跳过）

**1. 一句话画像**

把这个人最核心的命理特征用一句普通话概括。从格局+旺衰+用神+神煞综合提炼，不是简单复述。

句式示例：
- "你是个水旺到极致、脑子转得飞快但容易想太多落不了地的思辨型人"
- "你是个有独到见解、不随流俗、中年后才真正显化的学者型人"

**2. 性格与天赋（白话版）**

把"日主喻象+十神性格+神煞组合+旺衰特征"翻译成日常语言：
- 日主喻象（壬水=江河大海、戊土=城墙堤岸、庚金=顽铁矿石等）→ "你像什么"
- 十神主气（伤官旺=才情型、正官格=规矩型、印旺=学问型等）→ "你的底层驱动"
- 神煞组合（华盖+太极=独到见解、天乙贵人=贵人缘、羊刃=刚强等）→ "你的天赋标签"
- 旺衰（身旺极=精力旺盛但易过载、身弱=承压需养等）→ "你的能量状态"

用"你是个……的人，特点是……"的句式。避免堆术语。

**3. 人生轨迹与关键阶段（白话版）**

把"大运流年+格局等级+病药说"翻译成人生阶段语言：
- 当下阶段在人生什么位置（蓄势期/转折期/显化期/稳守期）
- 关键转折节点（哪几年要抓住、哪几年要稳）
- 整体人生曲线（先苦后甜/稳中有升/大器晚成/少年得志等）

用"你现在大概在……阶段，接下来几年……"的句式。

**4. 现实功课（白话版）**

把"用神+忌神+病药说+流转阻塞点"翻译成具体可操作的生活建议：
- 工作方向（适合什么类型、不适合什么）
- 财务节奏（何时稳何时进、早年晚年差异）
- 关系模式（亲密关系的特点与功课）
- 自我修养（怎么补命局的缺、怎么化解命局的病）

用"你这局最该做的是……，最该避的是……"的句式。

**5. 三个关键词**

最后给三个关键词收束，让读者记住要点。这三个词要从整个分析中提炼，不是随便给。

#### 风格规范（必须遵守）

1. **只翻译已有判断，不新增命理结论**：白话部分所有命理依据必须在前面的专业步骤中已经论证过。不允许在白话部分偷偷加新判断。若发现白话部分有前面未论证的命理内容，必须回退到专业部分补论证，或从白话部分删除。
2. **不复述专业术语，翻译成生活语言**：专业部分说"戊癸合绊，孤杀无制"，白话部分说"你的管束力被牵制住了，自己定的规矩常执行不下去"——是翻译不是复述。不要在白话部分堆砌格局清纯度、有情有力、流转顺畅度等术语。
3. **遵循 safety-tone，不用绝对断语**：用"倾向/较容易/传统上这样理解/需要结合现实选择"，不用"必然/注定/一定会"。
4. **保持温度**：有理解、有共情，让人读完感到"被看见"而非"被判决"。不冷冰冰翻译，也不煽情。
5. **长度适中**：整体 600-1000 字。不能太短（没翻译透）也不能太长（变啰嗦）。

#### 与专业部分的关系

- 专业部分（Step 1-8）是命理依据，必须完整保留
- 白话解读（Step 9）是翻译层，追加在最末尾
- 两者不是替代关系，是互补关系：专业读者看前面，普通读者看末尾，两者都看则互相对照
- 若白话解读与专业部分出现矛盾，以专业部分为准，修正白话解读
...
性格与天赋：
[日主喻象+十神主气+神煞组合+旺衰特征 → 翻译成日常语言]
你是个……的人，特点是……

人生轨迹与关键阶段：
[大运流年+格局等级+病药说 → 翻译成人生阶段语言]
你现在大概在……阶段，接下来几年……，整体人生曲线……

现实功课：
[用神+忌神+病药说+流转阻塞点 → 翻译成可操作建议]
工作方向：……
财务节奏：……
关系模式：……
自我修养：……
...
> ⚠️ 白话解读只翻译前面已论证的判断，不新增命理结论。若与专业部分矛盾，以专业部分为准。长度 600-1000 字。夫妻合参不追加本模块。
...
**错误表现：** 在最末尾的"整体白话解读"中偷偷加入前面专业部分没有论证过的新命理判断，或白话部分与专业部分矛盾。例如专业部分未提"从格"，白话部分却说"你这局是从格，所以……"；专业部分判"身弱"，白话部分却说"你身旺，所以……"。

**正确做法：** 白话解读是"翻译层"，只翻译前面 Step 1-8 已论证的判断，不新增命理结论。所有命理依据必须在前面的专业步骤中已经给出。若发现白话部分需要某个前面未论证的命理点，必须先回退到专业部分补论证，再在白话部分翻译，或从白话部分删除该内容。

**自检问题：**
- 白话部分的每个判断，前面专业部分是否已经论证过？
- 白话部分有没有偷偷加新的命理结论（前面没提的格局、用神、神煞解读）？
- 白话部分与专业部分是否矛盾？若矛盾，是否回退修正了专业部分或白话部分？

---

*错误清单更新日期：2026-07-03 | 基于实际分析错误总结（#7 新增：透干信号低估；#8 新增：白话解读脱离专业判断）*
